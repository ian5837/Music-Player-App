...
import 'package:music_player_app/src/components/flute_music_player.dart';
import 'package:music_player_app/src/models/album.dart';
import 'package:music_player_app/src/models/playback.dart';
...
import 'package:music_player_app/src/service/musicservice.dart';
...
class ZMusicPlayerBloc {
  ...
  Future<void> fetchSongs() async {
    ...
    await store.fetchResultsByQuery("black+pink").then(
      (data) {
        _songs$.add(data);
      },
    );
